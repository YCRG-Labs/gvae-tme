...
Training proceeds in two phases with distinct objectives, optimized using Adam \citep{kingma2014adam} with cosine annealing learning rate scheduling.
